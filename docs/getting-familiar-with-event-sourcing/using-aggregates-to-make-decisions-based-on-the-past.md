...
<figure class="scheme">
    <img class="scheme_figure" src="/docs/laravel-event-sourcing/v3/images/aggregate-01.svg">
</figure>
...
<figure class="scheme">
    <img class="scheme_figure" src="/docs/laravel-event-sourcing/v3/images/aggregate-02.svg">
</figure>
...
<figure class="scheme">
    <img class="scheme_figure" src="/docs/laravel-event-sourcing/v3/images/aggregate-03.svg">
</figure>

Step 4: The aggregate gets persisted, and the account limit hit event gets written into the database.

<figure class="scheme">
    <img class="scheme_figure" src="/docs/laravel-event-sourcing/v3/images/aggregate-04.svg">
</figure>
...
<figure class="scheme">
    <img class="scheme_figure" src="/docs/laravel-event-sourcing/v3/images/aggregate-05.svg">
</figure>
...
<figure class="scheme">
    <img class="scheme_figure" src="/docs/laravel-event-sourcing/v3/images/aggregate-06.svg">
</figure>
